...
def passwrd():
	print('\033[0;92m==================')
	print("\033[97;1m[\033[92;1m➢\033[97;1m] \x1b[33m\x1b[33m\x1b[33m[\033[0;92m@SSWSG\x1b[36m/Ghassan\x1b[33m] \033[1;92m ")
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{AKH_T}[\033[1;31m Ghassan \033[1;32m\033[1;33m\033[1;34m\033[1;35m\033[1;32m]  {P}{b}{loop}{P}•{b}{len(id)}{P}   OK:{P}{H}{ok}{P}   CP:{P}{M}{cp}{P}  {bo}{'{:.0%}'.format(loop/float(len(id)))}{asu}  "),
	sys.stdout.flush()
